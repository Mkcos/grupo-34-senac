        ...
        <nav className="pt-8 width-max">
            ...
            <div className=" header flex items-center items-center justify-between uppercase mt-6">
                ...
                <div className=' flex justify-between w-2/6 h-12 border-2 rounded-md px-2 py-1'>
                    <input className='w-full bg-transparent h-full outline-none' type="text" placeholder="O que você quer aprender?"></input>
                    <div>
                    </div>
                    <div>
                        <a href=''>
                ...
                <a href='' className="enter font-semibold font-2xl text-center text-xl">Entrar</a>
